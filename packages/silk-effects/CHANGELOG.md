...
| --- | --- | --- | --- | --- |
| @effected/github-references | dependency | updated | ^0.4.0 | ^0.5.0 |
...
| @savvy-web/silk-core | dependency | updated | 0.4.3 | 0.4.4 |
| @effected/commands | peerDependency | updated | ^0.8.0 | ^0.9.0 |
| @effected/git | peerDependency | updated | ^0.16.0 | ^0.17.0 |
| @effected/templates | peerDependency | updated | ^0.7.0 | ^0.8.0 |
| @effected/workspaces | peerDependency | updated | ^0.24.0 | ^0.25.0 |
...
| @savvy-web/silk-core | dependency | updated | 0.4.3 | 0.4.3 |
...
- `DepsRegen` writes each package's pure-dependency changeset to a stable, package-derived filename — `<scope>-<name>-deps.md` for scoped packages (`savvy-web-cli-deps.md`), `<name>-deps.md` otherwise — instead of a random `<adjective>-<noun>-<verb>` slug. A re-run overwrites the same file in place, so a no-op regen produces no file churn; a legacy random-named pure-dependency changeset for the same package is deleted on the first regen that rewrites it. The stable path is written only when it is free — absent, or this branch's own pure-dependency changeset for that package; a file present at the merge base (an earlier, unreleased regen for the same package), a prose or mixed changeset, or another package's file at that path is never overwritten and the write goes to the first free `…-deps-2.md` sibling instead. Detection still classifies by content, so hand-written pure-dependency changesets under other names keep working.
...
- Dependency changesets generated across a config-dependency bump no longer omit `peerDependency` rows resolved through hook-injected catalogs. [#681][#681]

### Dependencies

| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/silk-core | dependency | updated | 0.4.2 | 0.4.3 |
| @effected/workspaces | peerDependency | updated | ^0.23.0 | ^0.24.0 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/github-references | dependency | updated | ^0.3.1 | ^0.4.0 |
...
| @savvy-web/silk-core | dependency | updated | 0.4.1 | 0.4.2 |
| @effected/commands | peerDependency | updated | ^0.7.0 | ^0.8.0 |
| @effected/git | peerDependency | updated | ^0.15.0 | ^0.16.0 |
| @effected/templates | peerDependency | updated | ^0.6.0 | ^0.7.0 |
| @effected/workspaces | peerDependency | updated | ^0.22.0 | ^0.23.0 |
...
| @savvy-web/silk-core | dependency | updated | 0.4.0 | 0.4.1 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/commands | peerDependency | updated | ^0.7.0 | ^0.7.1 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/silk-core | dependency | updated | 0.1.1 | 0.1.2 |
...
| @savvy-web/silk-core | dependency | updated | 0.1.0 | 0.1.1 |
| @effected/git | peerDependency | updated | ^0.15.0 | ^0.15.1 |
...
- The errors, schemas, `PrBody` contract and `trimTrailingSlashes` now live in the new `@savvy-web/silk-core` package. `@savvy-web/silk-effects` depends on it and re-exports every one of those names, so no import changes are required. [#638][#638]

### Dependencies

| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/silk-core | dependency | added | — | 0.1.0 |
...
| @effected/commands | peerDependency | updated | ^0.6.1 | ^0.7.0 |
...
- `MaintenanceNotePlugin` now inserts its `### Maintenance` note into a version block whose only content is the `No changes in this release.` placeholder that `@changesets/apply-release-plan` (>= 8.1.0) added for an otherwise-empty release, splicing the note in place of the placeholder rather than leaving both — or, previously, neither — in the rendered changelog. Older engine versions left such a block structurally empty, which is still handled the same way, and the plugin remains idempotent once the note is present. [#610][#610]

### Dependencies

| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @changesets/apply-release-plan | dependency | updated | ^8.0.0 | ^8.1.0 |
| @changesets/get-github-info | dependency | updated | ^1.0.0 | ^1.0.1 |
| @changesets/get-release-plan | dependency | updated | ^5.0.0 | ^5.0.1 |
| @effected/github-references | dependency | updated | ^0.1.0 | ^0.2.0 |
...
- `VersionFiles.processResolvedVersionFiles` now skips a scope whose manifest declares no version, leaving its `versionFiles` targets untouched rather than stamping them with a fabricated version [#605][#605]

### Dependencies

| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/markdown | dependency | updated | ^0.8.0 | ^0.8.1 |
