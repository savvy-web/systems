...
| `Repos.ReposLockdown` | [README](../README.md#reposmanager-reposdrift-and-reposlockdown) | Hold every vendored tree read-only between mutations (files `0444`, directories `0555`) |
