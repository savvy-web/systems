...
// Discriminates a Silk-authored config file from a vanilla changesets config.
...
export class ChangesetConfig extends Context.Service<ChangesetConfig, ChangesetConfigShape>()(
	 ...
	 * @public
	 */
	static readonly layer: Layer.Layer<ChangesetConfig, never, ChangesetConfigReader> = Layer.effect(
		this,
		Effect.gen(function* () {
