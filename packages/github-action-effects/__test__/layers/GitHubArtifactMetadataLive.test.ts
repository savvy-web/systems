...
import { GitHubArtifactMetadataLive } from "../../src/layers/GitHubArtifactMetadataLive.js";
import { GitHubArtifactMetadata } from "../../src/services/GitHubArtifactMetadata.js";
...
const run = <A, E>(effect: Effect.Effect<A, E, GitHubArtifactMetadata>) => Effect.provide(effect, testLayer);
...
describe("GitHubArtifactMetadataLive", () => {
	describe("createStorageRecord", () => {
		it.effect("posts the record and returns the created ids", () =>
			Effect.gen(function* () {
		...
		it.effect("fails with GitHubArtifactMetadataError when the request fails", () =>
			Effect.gen(function* () {
