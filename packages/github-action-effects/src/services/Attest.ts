...
export interface AttestShape {
	 ...
	 * Requires `FileSystem.FileSystem` so it composes with
 ...
 * @public
 */
export class Attest extends Context.Service<Attest, AttestShape>()("github-action-effects/Attest") {}
