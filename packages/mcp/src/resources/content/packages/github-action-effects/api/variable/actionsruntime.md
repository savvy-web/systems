...
```ts
ActionsRuntime: {
    readonly Default: Layer.Layer<import("../index.js").ActionEnvironment | import("../index.js").ActionLogger | import("../index.js").ActionOutputs | import("../index.js").ActionState | import("@effect/platform/FileSystem").FileSystem | import("@effect/platform/HttpClient").HttpClient, never, never>;
}
```
