...
```ts
AppLayer: Layer.Layer<import("../index.js").BuildService | import("../index.js").ConfigService | import("../index.js").PersistLocalService | import("../index.js").ValidationService, never, never>
```
