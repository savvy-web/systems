...
summary: "The content between managed section markers. Equal compares normalized content only (trimmed, whitespace-collapsed). Use to compute line-level differences."
tier: packages
source: generated
...
The content between managed section markers. Equal compares normalized content only (trimmed, whitespace-collapsed). Use to compute line-level differences.
