---
id: packages/silk-effects/api/variable/changesetconfigfile
title: "ChangesetConfigFile — silk-effects variable"
summary: "Standard changesets configuration matching the `@changesets/config@3.1.1` spec."
tier: packages
source: generated
...
```ts
ChangesetConfigFile: Schema.Struct<{
