...
```ts
ActionEnvironmentTest: {
  readonly layer: (env: Record<string, string>, payload?: WebhookPayload) => Layer.Layer<ActionEnvironment>; /** Create test layer with default GitHub Actions environment. */
