...
class ArtifactError extends ArtifactError_base<{
  readonly operation: "upload" | "download" | "list" | "get" | "delete"; /** Artifact name or id (string for uniform formatting). */
  readonly artifact: string; /** Human-readable description of what went wrong. */
