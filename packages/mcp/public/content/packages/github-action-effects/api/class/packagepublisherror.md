...
class PackagePublishError extends PackagePublishError_base<{
  readonly operation: "setupAuth" | "pack" | "publish" | "publishTarball" | "verifyIntegrity" | "publishToRegistries" | "publishIdempotent" | "dryRun"; /** The package name, if applicable. */
  readonly pkg?: string; /** The registry URL, if applicable. */
  readonly registry?: string; /** Human-readable description of what went wrong. */
