...
class SemverResolverError extends SemverResolverError_base<{
  readonly operation: "compare" | "satisfies" | "latestInRange" | "increment" | "parse"; /** The version string involved. */
  readonly version: string; /** Human-readable description of what went wrong. */
