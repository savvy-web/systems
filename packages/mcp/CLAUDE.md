...
- Resource layer: `silk://catalog` plus a `silk://{+path}` template over a compiled markdown corpus, including `silk://standards/turbo/*` and the generated `silk://packages/<pkg>/api/*` API-reference docs.
