...
| --- | --- | --- | --- | --- |
| @microsoft/api-extractor | dependency | updated | ^7.59.2 | 7.59.1 |
| @microsoft/tsdoc | dependency | updated | \~0.17.0 | \~0.16.0 |
| @microsoft/tsdoc-config | dependency | updated | \~0.18.2 | 0.18.1 |
...
| @microsoft/api-extractor | dependency | updated | ^7.59.1 | ^7.59.2 |
...
| @effected/tsconfig-json | dependency | updated | ^0.10.1 | ^0.11.0 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/tsconfig-json | dependency | updated | ^0.10.0 | ^0.10.1 |
...
| @effected/tsconfig-json | dependency | updated | ^0.9.2 | ^0.10.0 |
...
[#670]: https://github.com/savvy-web/systems/pull/670
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @tsdoctor/manifest | dependency | updated | ^0.1.0 | ^0.2.0 |
| @effected/glob | dependency | added | — | ^0.6.0 |
| @effected/jsonc | dependency | added | — | ^0.11.0 |
| @effected/semver | dependency | added | — | ^0.7.0 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/tsconfig-json | dependency | updated | ^0.9.0 | ^0.9.1 |
...
- Every prod build now removes a previously emitted `tsdoctor.json` and `og/` from the group's `meta/` bundle and from each `meta.localPaths` destination when the current build no longer produces them, so dropping a package's identity or its generator stops advertising the stale identity and `og:image`. [#598][#598]
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/tsconfig-json | dependency | updated | ^0.6.1 | ^0.7.0 |
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @effected/tsconfig-json | dependency | updated | ^0.5.0 | ^0.6.0 |  |
