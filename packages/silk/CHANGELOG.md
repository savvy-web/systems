...
| @savvy-web/changelog | dependency | updated | 1.0.6 | 1.0.7 |
| @savvy-web/cli | dependency | updated | 3.2.7 | 3.2.8 |
| @savvy-web/mcp | dependency | updated | 3.2.3 | 3.2.4 |
| @savvy-web/silk-effects | dependency | updated | 9.1.2 | 9.1.3 |
| @commitlint/cli | peerDependency | updated | ^21.2.2 | ^21.2.3 |
| @commitlint/config-conventional | peerDependency | updated | ^21.2.2 | ^21.2.3 |
| markdownlint-cli2 | peerDependency | updated | ^0.23.2 | ^0.23.3 |
| markdownlint-cli2-formatter-codequality | peerDependency | updated | ^0.0.7 | ^0.0.8 |
| tsx | peerDependency | updated | ^4.23.13 | ^4.23.15 |
| turbo | peerDependency | updated | ^2.11.2 | ^2.11.3 |
...
| @savvy-web/changelog | dependency | updated | 1.0.5 | 1.0.6 |
| @savvy-web/cli | dependency | updated | 3.2.6 | 3.2.7 |
| @savvy-web/mcp | dependency | updated | 3.2.2 | 3.2.3 |
| @savvy-web/silk-effects | dependency | updated | 9.1.1 | 9.1.2 |
...
| @savvy-web/changelog | dependency | updated | 1.0.4 | 1.0.5 |
| @savvy-web/cli | dependency | updated | 3.2.5 | 3.2.6 |
| @savvy-web/mcp | dependency | updated | 3.2.1 | 3.2.2 |
| @savvy-web/silk-effects | dependency | updated | 9.1.0 | 9.1.1 |
...
[#685]: https://github.com/savvy-web/systems/pull/685
...
| @savvy-web/changelog | dependency | updated | 1.0.2 | 1.0.3 |
| @savvy-web/cli | dependency | updated | 3.2.3 | 3.2.4 |
| @savvy-web/mcp | dependency | updated | 3.1.3 | 3.2.0 |
...
| @savvy-web/changelog | dependency | updated | 1.0.1 | 1.0.2 |
| @savvy-web/cli | dependency | updated | 3.2.2 | 3.2.3 |
| @savvy-web/mcp | dependency | updated | 3.1.2 | 3.1.3 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 1.0.0 | 1.0.1 |
| @savvy-web/cli | dependency | updated | 3.2.1 | 3.2.2 |
| @savvy-web/mcp | dependency | updated | 3.1.1 | 3.1.2 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 0.1.2 | 0.1.3 |
| @savvy-web/cli | dependency | updated | 3.0.3 | 3.0.4 |
| @savvy-web/mcp | dependency | updated | 3.0.3 | 3.0.4 |
| @savvy-web/silk-effects | dependency | updated | 8.0.3 | 8.0.4 |
...
| @savvy-web/cli | dependency | updated | 3.0.2 | 3.0.3 |
| @savvy-web/mcp | dependency | updated | 3.0.2 | 3.0.3 |
...
| @savvy-web/changelog | dependency | updated | 0.1.2 | 0.1.2 |
| @savvy-web/cli | dependency | updated | 3.0.0 | 3.0.1 |
| @savvy-web/mcp | dependency | updated | 3.0.0 | 3.0.1 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.2 |
| @savvy-web/cli | dependency | updated | 2.11.4 | 3.0.0 |
| @savvy-web/mcp | dependency | updated | 2.7.5 | 3.0.0 |
| @savvy-web/silk-effects | dependency | updated | 7.5.3 | 8.0.0 |

### Maintenance

- The deprecated `./changesets/changelog` shim now reads `VITEST`/`GITHUB_ACTIONS` itself and provisions the log mode through `Changesets.makeChangelogFunctions`; behaviour is unchanged [#638][#638]
...
| @savvy-web/cli | dependency | updated | 2.11.3 | 2.11.4 |
| @savvy-web/mcp | dependency | updated | 2.7.4 | 2.7.5 |
...
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.11.2 | 2.11.3 |
| @savvy-web/mcp | dependency | updated | 2.7.3 | 2.7.4 |
...
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.11.1 | 2.11.2 |
| @savvy-web/mcp | dependency | updated | 2.7.2 | 2.7.3 |
...
[#627]: https://github.com/savvy-web/systems/pull/627
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @changesets/cli | peerDependency | updated | ^3.0.1 | ^3.0.2 |
| @types/bun | peerDependency | updated | ^1.4.0 | ^1.4.1 |
| @vitest/coverage-istanbul | peerDependency | updated | ^4.1.11 | ^5.0.0 |
| @vitest/coverage-v8 | peerDependency | updated | ^4.1.11 | ^5.0.0 |
| lint-staged | peerDependency | updated | ^17.4.1 | ^17.5.0 |
| vitest | peerDependency | updated | ^4.1.11 | ^5.0.0 |
| vite | peerDependency | added | — | ^8.2.2 |
...
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.10.0 | 2.11.0 |
| @savvy-web/mcp | dependency | updated | 2.7.0 | 2.7.1 |
...
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.9.3 | 2.10.0 |
| @savvy-web/mcp | dependency | updated | 2.7.0 | 2.7.0 |
| @biomejs/biome | peerDependency | updated | 2.5.11 | 2.5.12 |
| @types/node | peerDependency | updated | ^26.4.0 | ^26.4.1 |
...
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.9.2 | 2.9.3 |
| @savvy-web/mcp | dependency | updated | 2.6.10 | 2.7.0 |
...
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.9.0 | 2.9.1 |
| @savvy-web/mcp | dependency | updated | 2.6.8 | 2.6.9 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @savvy-web/mcp | dependency | updated | 2.6.6 | 2.6.7 |
...
| --- | --- | --- | --- | --- |
| @savvy-web/changelog | dependency | updated | 0.1.1 | 0.1.1 |
| @savvy-web/cli | dependency | updated | 2.8.1 | 2.8.2 |
| @savvy-web/mcp | dependency | updated | 2.6.5 | 2.6.6 |
