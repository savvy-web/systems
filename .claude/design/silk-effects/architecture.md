...
| --- | --- | --- |
| `Changesets` | transformer, linter, changelog formatter, remark plugins + presets, markdownlint rules, services (`ConfigInspector`, `BranchAnalyzer`, `WorkspaceSnapshotReader`, …), schemas and the class API wrappers | `src/changesets/` |
