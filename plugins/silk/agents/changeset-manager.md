...
- **Internal design docs and specs**: markdown under `.claude/design/`, `.claude/plans/`, `okf/`, `docs/internal/`, or other directories holding documentation aimed at project maintainers rather than package consumers.
