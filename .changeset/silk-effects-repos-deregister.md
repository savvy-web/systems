...
* Refuses, typed and before any mutation, a section that is still the canonical registration of a live manifest entry — reconciling those is `sync`'s job and unvendoring is `remove`'s
