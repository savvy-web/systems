...
* [layers.json](layers-json.md) - The single source of truth for which layer each app package sits in, a @effected/workspaces LayerPolicy read by silk's package-layering test to hold the live dependency graph to the declared layering.
